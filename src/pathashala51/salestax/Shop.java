 ...
 class Shop {
  ...
  public static void main(String[] args) throws IOException {
   ...
   private static ProductType inputProductType(Scanner reply) {
     ...
     switch (option){
       case 1: type= ProductType.IMPORTED_AND_EXEMPTED;
         break;
       case 2: type=ProductType.IMPORTED_AND_UNEXEMPTED;
         break;
       case 3: type=ProductType.UNIMPORTED_AND_EXEMPTED;
         break;
       case 4: type=ProductType.UNIMPORTED_AND_UNEXEMPTED;
         break;
       default:type=ProductType.UNIMPORTED_AND_UNEXEMPTED;
     }
     return type;
   }
